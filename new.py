...
# ag_news_label = {1: "World", # Removed AG_NEWS labels
#                  2: "Sports",
#                  3: "Business",
#                  4: "Sci/Tec"}

# Use your category mapping for classification example
custom_label_map = id_to_category # Use the created id_to_category map
...
def classify_news(news):
    ...
    model.eval()
    with torch.no_grad():
        pred_id = model(x_int).argmax(1).item()
        predicted_category = custom_label_map[pred_id] # Use custom label map
    print(f"This is a {predicted_category} news")

# Example usage with your data:
news = "Robbery at Main Street Bank, suspect still at large."
classify_news(news)

news = "A car was speeding and hit a pedestrian at the corner of Elm and Oak."
classify_news(news)
